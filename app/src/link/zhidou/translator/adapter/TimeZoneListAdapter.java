...
public class TimeZoneListAdapter extends BaseAdapter {
    ...
    private static final String TAG = TimeZoneListAdapter.class.getSimpleName();
    private float mDisabledAlpha;
    public static final int CONTENT = 0;
    public static final int DIVIDER = 1;
    public TimeZoneListAdapter(Context context, ArrayList<SettingBean> results) {
        mContext = context;
        mResults = results;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (CONTENT == getItemViewType(position)) {
            if (convertView == null) {
                ...
                convertView = layoutInflater.inflate(R.layout.time_zone_choice_list_item, null);
