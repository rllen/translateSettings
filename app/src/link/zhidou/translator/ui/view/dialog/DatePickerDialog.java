...
public class DatePickerDialog extends AlertDialog implements OnClickListener,
    ...
    private static final String VALIDATION_CALLBACK_CLASS_NAME = "android.widget.DatePicker.ValidationCallback";
    private static final String setValidationCallback = "setValidationCallback";
...
//        setButtonPanelLayoutHint(LAYOUT_HINT_SIDE);
    ...
    private void updateTitle(int year, int month, int day) {
        if (DEBUG) {
            Log.d(TAG, "updateTitle, year: " + year + ", month: " + month + ", day: " + day);
        }
