 ...
 * @author keetom
 */
public class AutoFitHeightTextView extends AppCompatTextView {
    ...
    private boolean isSingleLineTextFlag;

    public void setSingleLineText(boolean b) {
        isSingleLineTextFlag = b;
    }
    ...
    public AutoFitHeightTextView(final Context context) {
        this(context, null, android.R.attr.textViewStyle);
    }

    public AutoFitHeightTextView(final Context context, final AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public AutoFitHeightTextView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        _sizeTester = new SizeTester() {
            ...
            public int onTestSize(final int suggestedSize, final RectF availableSpace) {
                ...
                if (transformationMethod != null) {
                    text = transformationMethod.getTransformation(getText(), AutoFitHeightTextView.this).toString();
                } else {
...
//        final int heightLimit = ((getMeasuredHeight() - getCompoundPaddingBottom() - getCompoundPaddingTop())/5)*4;
        final int heightLimit = ((getMeasuredHeight() - getCompoundPaddingBottom() - getCompoundPaddingTop())/1)*1;
        ...
        if(isSingleLineTextFlag){
            _availableSpaceRect.bottom = heightLimit/2;
        }else{
