...
public class InputMethodRecyclerView extends RecyclerView {
    private static final String TAG = InputMethodRecyclerView.class.getSimpleName();
    ...
    public InputMethodRecyclerView(Context context) {
        super(context);
    }

    public InputMethodRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public InputMethodRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
     ...
     * 设置默认选中.
     */
    public void setDefaultSelect(int pos, boolean setFocusFlag) {
        if(setFocusFlag){
