...
//        return mAdapter.getUuids();
        try {
            return (ParcelUuid[]) MethodUtils.invokeMethod(mAdapter, "getUuids", new Object[]{});
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
...
//        return mAdapter.getConnectionState();
        try {
            return (int) MethodUtils.invokeMethod(mAdapter, "getConnectionState", new Object[]{});
        } catch (Exception e) {
            e.printStackTrace();
        }
        return -1;
...
//        mAdapter.setDiscoverableTimeout(timeout);
        try {
            MethodUtils.invokeMethod(mAdapter, "setDiscoverableTimeout", new Object[]{timeout});
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void setScanMode(int mode) {
        try {
            MethodUtils.invokeMethod(mAdapter, "setScanMode", new Object[]{mode});
        } catch (Exception e) {
            e.printStackTrace();
        }
//        mAdapter.setScanMode(mode);
    ...
    public boolean setScanMode(int mode, int duration) {
        try {
            MethodUtils.invokeMethod(mAdapter, "setScanMode", new Object[]{mode, duration});
        } catch (Exception e) {
            e.printStackTrace();
        }
        return false;
//        return mAdapter.setScanMode(mode, duration);
    ...
    public void setBluetoothEnabled(boolean enabled) {
        boolean success = enabled
                ...
                : mAdapter.disable();
        if (DEBUG) {
            Log.d(TAG, "success: " + success + ", enabled: " + enabled);
        }
        if (success) {
