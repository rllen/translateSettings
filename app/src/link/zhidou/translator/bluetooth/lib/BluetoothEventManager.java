 ...
 * Settings.
 */
public final class BluetoothEventManager implements HiddenActions {
    ...
    BluetoothEventManager(LocalBluetoothAdapter adapter,
        ...
        addHandler(ACTION_DISAPPEARED, new DeviceDisappearedHandler());
        addHandler(BluetoothDevice.ACTION_NAME_CHANGED, new NameChangedHandler());
        addHandler(ACTION_ALIAS_CHANGED, new NameChangedHandler());

        // Pairing broadcasts
        addHandler(BluetoothDevice.ACTION_BOND_STATE_CHANGED, new BondStateChangedHandler());
        addHandler(ACTION_PAIRING_CANCEL, new PairingCancelHandler());
    ...
    private class BondStateChangedHandler implements Handler {
        public void onReceive(Context context, Intent intent,
            ...
            if (bondState == BluetoothDevice.BOND_NONE) {
                int reason = intent.getIntExtra(EXTRA_REASON,
                        BluetoothDevice.ERROR);
        ...
        private void showUnbondMessage(Context context, String name, int reason) {
            ...
            switch(reason) {
            case UNBOND_REASON_AUTH_FAILED:
