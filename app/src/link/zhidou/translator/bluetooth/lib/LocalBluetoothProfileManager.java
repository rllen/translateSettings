 ...
 */
public final class LocalBluetoothProfileManager implements HiddenActions{
    private static final String TAG = "LBPM";
...
//            int role = intent.getIntExtra(EXTRA_LOCAL_ROLE, 0);
