...
public final class BluetoothDeviceFilter implements HiddenActions{
        ...
        boolean matches(ParcelUuid[] uuids, BluetoothClass btClass) {
            if (uuids != null) {
                ...
                if (doesClassMatch(btClass, PROFILE_A2DP) ||
                        doesClassMatch(btClass, PROFILE_HEADSET)) {
                    return true;
                }
            }
            return false;
    ...
    private static final class TransferFilter extends ClassUuidFilter {
        ...
        boolean matches(ParcelUuid[] uuids, BluetoothClass btClass) {
            ...
            return btClass != null
                    && doesClassMatch(btClass, PROFILE_OPP);
        }
    }
    ...
    private static final class PanuFilter extends ClassUuidFilter {
        ...
        boolean matches(ParcelUuid[] uuids, BluetoothClass btClass) {
            ...
            return btClass != null
                    && doesClassMatch(btClass, PROFILE_PANU);
        }
    }
    ...
    private static final class NapFilter extends ClassUuidFilter {
        ...
        boolean matches(ParcelUuid[] uuids, BluetoothClass btClass) {
            ...
            return btClass != null
                    && doesClassMatch(btClass, PROFILE_NAP);
        }
    }
}
