 ...
 */
public final class HeadsetProfile implements LocalBluetoothProfile,HiddenActions {
    ...
    private boolean connectImpl(BluetoothDevice device) {
        try {
    ...
    private boolean disconnectImpl(BluetoothDevice device) {
        try {
