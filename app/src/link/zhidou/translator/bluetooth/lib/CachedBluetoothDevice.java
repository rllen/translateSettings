...
public final class CachedBluetoothDevice implements Comparable<CachedBluetoothDevice> {
    ...
    void onProfileStateChanged(LocalBluetoothProfile profile, int newProfileState) {
        ...
        {
            if (DEBUG) Log.d(TAG, " BT Turninig Off...Profile conn state change ignored...");
            return;
        }
...
//        }
    ...
    public void unpair() {
        ...
        if (state != BluetoothDevice.BOND_NONE) {
            ...
            if (dev != null) {
                final boolean successful = removeBond(dev);
                if (successful) {
                    if (DEBUG) {
    ...
    private void cancelBondProcess() {
        try {
            MethodUtils.invokeMethod(mDevice, "cancelBondProcess", new Object[]{});
        }catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private boolean removeBond(BluetoothDevice device) {
        try {
            return (boolean) MethodUtils.invokeMethod(device, "removeBond", new Object[]{});
        }catch (Exception e) {
            e.printStackTrace();
        }
        return false;
    ...
    private String getAliasName() {
        try {
            return  (String)  MethodUtils.invokeMethod(mDevice, "getAliasName", new Object[]{});
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    private void setAlias(String name) {
        try {
            MethodUtils.invokeMethod(mDevice, "setAlias", new Object[]{name});
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private boolean updateProfiles() {
        ...
        if (DEBUG) {
            Log.e(TAG, "updating profiles for " + getAliasName());
    ...
    private boolean isBluetoothDock() {
        try {
            return (boolean) MethodUtils.invokeMethod(mDevice, "isBluetoothDock", new Object[]{});
        } catch (Exception e) {
            e.printStackTrace();
        }
        return false;
    ...
    public int getPhonebookPermissionChoice() {
        int permission = getPhonebookAccessPermission();
    ...
    public void setPhonebookPermissionChoice(int permissionChoice) {
        ...
        setPhonebookAccessPermission(permission);
    }
    ...
    private void migratePhonebookPermissionChoice() {
        ...
        if (getPhonebookAccessPermission() == ACCESS_UNKNOWN) {
    ...
    public int getMessagePermissionChoice() {
        int permission = getMessageAccessPermission();
        if (permission == ACCESS_ALLOWED) {
            return ACCESS_ALLOWED;
        } else if (permission == ACCESS_REJECTED) {
            return ACCESS_REJECTED;
    ...
    public void setMessagePermissionChoice(int permissionChoice) {
        ...
        setMessageAccessPermission(permission);
    }

    public int getSimPermissionChoice() {
        int permission = getSimAccessPermission();
        if (permission == ACCESS_ALLOWED) {
            return ACCESS_ALLOWED;
        } else if (permission == ACCESS_REJECTED) {
            return ACCESS_REJECTED;
    ...
    void setSimPermissionChoice(int permissionChoice) {
        ...
        setSimAccessPermission(permission);
    }

    private void setSimAccessPermission(int permission) {
        try {
            MethodUtils.invokeMethod(mDevice, "setSimAccessPermission", new Object[]{permission});
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    private void setMessageAccessPermission(int permission) {
        try {
            MethodUtils.invokeMethod(mDevice, "setMessageAccessPermission", new Object[]{permission});
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    private void setPhonebookAccessPermission(int permission) {
        try {
            MethodUtils.invokeMethod(mDevice, "setPhonebookAccessPermission", new Object[]{permission});
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private int getPhonebookAccessPermission() {
        try {
            return (int) MethodUtils.invokeMethod(mDevice, "getPhonebookAccessPermission", new Object[]{});
        } catch (Exception e) {
            e.printStackTrace();
        }
        return -1;
    ...
    private int getMessageAccessPermission() {
        try {
            return (int) MethodUtils.invokeMethod(mDevice, "getMessageAccessPermission", new Object[]{});
        } catch (Exception e) {
            e.printStackTrace();
        }
        return -1;
    ...
    private int getSimAccessPermission() {
        try {
            return (int) MethodUtils.invokeMethod(mDevice, "getSimAccessPermission", new Object[]{});
        } catch (Exception e) {
            e.printStackTrace();
        }
        return -1;
    ...
    private void migrateMessagePermissionChoice() {
        ...
        if (getMessageAccessPermission() == ACCESS_UNKNOWN) {
            int oldPermission = preferences.getInt(mDevice.getAddress(), ACCESS_UNKNOWN);
            if (oldPermission == ACCESS_ALLOWED) {
    ...
    private void processPhonebookAccess() {
        ...
        ParcelUuid[] uuids = mDevice.getUuids();
        if (BluetoothUuid.containsAnyUuid(uuids, PBAB_CLIENT_UUIDS)) {
