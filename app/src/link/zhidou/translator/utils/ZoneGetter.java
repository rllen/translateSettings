...
public class ZoneGetter {
    ...
    public static String[] forLocale(Locale locale) {
        try {
            Class cls = Class.forName("libcore.icu.TimeZoneNames");
            Object localeData = MethodUtils.invokeStaticMethod(cls, "forLocale", new Object[]{locale});
    ...
    public static List<Map<String, Object>> getZonesList(Context context) {
        ...
        for (String olsonId : forLocale(locale)) {
    ...
    private static String getZoneDisplayName(Locale locale, TimeZone tz, Date now,
        ...
        if (preferLongName) {
            ...
            zoneNameString = getExemplarLocation(locale, tz);
    ...
    private static String getExemplarLocation(Locale locale, TimeZone tz) {
        try {
            Class cls = Class.forName("libcore.icu.TimeZoneNames");
            Object localeData = MethodUtils.invokeStaticMethod(cls, "getExemplarLocation", new Object[]{locale.toString(), tz.getID()});
            return  (String) localeData;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static List<String> readTimezonesToDisplay(Context context) {
        ...
        try (XmlResourceParser xrp = context.getResources().getXml(R.xml.timezones)) {
            ...
            android.util.Log.e(TAG, "Ill-formatted timezones.xml file");
